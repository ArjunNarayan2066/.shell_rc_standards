...
def main():
	...
	parser.add_argument('-f',  dest="filepath", default="~/files_to_copy.yaml", help='File path')
	parser.add_argument('-c',  dest="create_yaml", default=False, action="store_true", help='Create yaml copy file')
	parser.add_argument('-e',  dest="edit_yaml", default=False, action="store_true", help='Edit yaml copy file')
